...
import os
import time
from denseflow.data.path import get_denseflow_path
...
class FlowExperiment(BaseExperiment):
    ...
    log_base = os.path.join(get_denseflow_path(), 'experiments/image/log')
    ...
    def eval_fn(self, epoch):
        ...
        with torch.no_grad():
            ...
            # samples = samples / 255.
            # save_image(samples, f"./generated_samples_baseline_flow_{self.args.dataset}/im{epoch}.png")
        return {'bpd': loss_sum/loss_count}